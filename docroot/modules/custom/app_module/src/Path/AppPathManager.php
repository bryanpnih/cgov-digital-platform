...
class AppPathManager implements AppPathManagerInterface, CacheDecoratorInterface {
   ...
   *
   * @var \Drupal\app_module\Path\AppPathStorageInterface
   */
  protected $storage;
   ...
   *   Cache backend.
   */
  public function __construct(AliasStorageInterface $storage, LanguageManagerInterface $language_manager, CacheBackendInterface $cache) {
