...
class AppPathManagerRegisterPathTest extends AppPathManagerTestBase {
  ...
  public function testRegisterPathNotGoodEntity() {
    ...
    $this->assertNull(
      $this->appPathManager->registerAppPath($test_entity, 'insert'),
  ...
  public function testGoodEntityNew() {
    ...
    $actual = $this->appPathManager->registerAppPath($entity, 'insert');
  ...
  public function testGoodEntityUpdate() {
    ...
    $actual = $this->appPathManager->registerAppPath($entity, 'update');
